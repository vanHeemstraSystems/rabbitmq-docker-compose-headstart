...
***TIP*** In creating your RabbitMQ client applications, it’s important not to overcomplicate things with too many channels. On the wire in marshaled frames, channels
...
they represent more. There are memory structures and objects set up for each channel. The more channels you have in a connection, the more memory RabbitMQ must use to manage the message flow for that connection. If you use them judiciously, you’ll have a happier RabbitMQ server.
